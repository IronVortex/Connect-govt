...
export default function SettingsPage() {
  ...
  return (
    <PageLayout>
      {/* Wrapper to handle clean vertical pacing between sections */}
      <div className="space-y-8 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* Right Column: Security & App Stats */}
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm shadow-slate-200/40">
              ...
              <div className="space-y-6">
                <div className="bg-slate-50/55 rounded-2xl p-6 border border-slate-100 flex flex-col justify-between gap-6">
                  <div>
