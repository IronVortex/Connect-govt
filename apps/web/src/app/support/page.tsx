  ...
  return (
    <PageLayout>
      <div className="space-y-8 py-6">
        ...
        <div className="rounded-[32px] border border-[#E0E7FF] bg-[#EEF2FF] p-8 shadow-sm shadow-slate-200/40">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap gap-3">
              <a 
                href="mailto:support@connectgov.example" 
                className="rounded-2xl bg-[#1D61FF] px-5 py-3 text-sm font-semibold text-white hover:bg-[#1553DB] transition-colors shadow-sm"
              >
                Email support
              </a>
              <a 
                href="tel:+18001234567" 
                className="rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 transition-colors shadow-sm"
              >
                Call now
              </a>
            </div>
